...
#include "Class.h"
/*
*Paladin class. Serves as a template as part of the greater class set.
*
*/
class Paladin :
	public Class
{
private:
	int spellsPerDay[6]; //Array storing the number of spells that can be cast per day.
	int smiteEvil; //The number of uses of Smite Evil.
	int layOnHands; //Number of times lay on hands can be used.
public:
	/*
